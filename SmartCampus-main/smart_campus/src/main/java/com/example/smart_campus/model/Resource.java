...
public class Resource {
    ...
    public static class ResourceBuilder {
        ...
        public ResourceBuilder availableFrom(LocalTime availableFrom) {
            this.availableFrom = availableFrom;
            return this;
        }

        public ResourceBuilder availableTo(LocalTime availableTo) {
            this.availableTo = availableTo;
            return this;
        }

        public ResourceBuilder status(ResourceStatus status) {
            this.status = status;
            return this;
        }

        public ResourceBuilder imageUrl(String imageUrl) {
            this.imageUrl = imageUrl;
            return this;
        }
